...
- (void)pushSearchAddress{
    ...
    __weak typeof(ViewController *) weself = self;
    [self presentToViewController:searchVC animation:JHAnimationType[Fade] completion:^{
        searchVC.cityString = weself.mapView.cityName;
    }];
}
