...
typedef enum BDSSynthesizerParamKey
{
    ...
    BDS_SYNTHESIZER_PARAM_AUDIO_ENCODING = BDS_SYNTHESIZER_PARAM_PID+3,           /* NSNumber(enum BDSSynthesizerAudioEncoding) */
     ...
     */
    BDS_SYNTHESIZER_PARAM_ONLINE_REQUEST_TIMEOUT = BDS_SYNTHESIZER_PARAM_USER_AGENT+2,
